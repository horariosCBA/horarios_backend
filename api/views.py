...
# Vista de planeacion pedagogica
class PlaneacionPedagogicaViewSet(viewsets.ModelViewSet):
    queryset = PlaneacionPedagogica.objects.all()
    serializer_class = PlaneacionPedagogicaSerializer
