...
class Competencia(models.Model):
    ...
    criterioEvaluacion = models.TextField(null=False, blank=False)
...
class Ficha(models.Model):
    ...
    fechaIncio = models.DateField(null=False, blank=False)
...
class Usuario(models.Model):
    ...
    documento = models.CharField(max_length=15, null=False, blank=False)
...
class PlaneacionPedagogica(models.Model):
    ...
    competencia = models.IntegerField(null=False, blank=False)
